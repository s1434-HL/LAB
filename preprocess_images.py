...
data_root = '/Users/hlj/Documents/NoSync.nosync/DL_Lab/IDRID_dataset/'
...
def fast_image_resize(input_path_folder, output_path_folder, output_size=None):
    ...
    for file in os.listdir(input_path_folder):
        if file != '.DS_Store':
            jobs.append((file, input_path_folder, output_path_folder, output_size))
...
if __name__ == "__main__":
    fast_image_resize(data_root+"/images/train/", "./train_images_resized_512/", output_size=(512, 512))
    fast_image_resize(data_root+"/images/test/", "./test_images_resized_512/", output_size=(512, 512))